...
class CustomModel(torch.nn.Module):
    def __init__(self, model_name, num_labels):
        ...
        self.bert = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels=num_labels).to(device)
        self.dropout = torch.nn.Dropout(p=0.2)  # Set dropout rate here
